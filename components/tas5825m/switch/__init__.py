...
EnableDacSwitch = tas5825m_ns.class_("EnableDacSwitch", switch.Switch, cg.Component)
EnableEqSwitch = tas5825m_ns.class_("EnableEqSwitch", switch.Switch , cg.Component)
...
async def to_code(config):
  ...
  if enable_dac_config := config.get(CONF_ENABLE_DAC):
    ...
    await cg.register_parented(s, tas5825m_component)
